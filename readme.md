...
- If you have many bots, consider creating a `settings-global.php` file and including it at the end of each settings file so you can change settings for them all in one place
